...
#define isA_CFString(p) (CFGetTypeID(p) == CFStringGetTypeID())
#define isA_CFNumber(p) (CFGetTypeID(p) == CFNumberGetTypeID())
#define isA_CFDate(p) (CFGetTypeID(p) == CFDateGetTypeID())
